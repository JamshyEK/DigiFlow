...
$mod_strings = array(
    ...
    'ERR_USER_IS_LOCKED_OUT' => 'This user is locked out of the DigitalFlow application and cannot log in using their existing password.',
    ...
    'LBL_GROUP_DESC' => 'Use for assigning items to a group (example: for Inbound Email). This type cannot login through the DigitalFlow web interface.',
    ...
    'LBL_PORTAL_ONLY_DESC' => 'Use for the Portal API. This type cannot login through the DigitalFlow web interface.',
    ...
    'LBL_REMINDER_TEXT' => 'Set a default for reminders for calls and meetings. Pop-up notifications appear for all invitees using DigitalFlow. Email reminders are sent to all invitees.',
    ...
    'LBL_SETTINGS_URL_DESC' => 'Use this URL when establishing login settings for the DigitalFlow Plug-in for Microsoft&reg; Outlook&reg; and the DigitalFlow Plug-in for Microsoft&reg; Word&reg;.',
    ...
    'LBL_SUITE_LOGIN' => 'Is DigitalFlow User',
    'LBL_THEME' => 'Themes',
    ...
    'LBL_ICAL_PUB_URL_HELP' => 'Use this URL to subscribe to the DigitalFlow calendar within iCal.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using DigitalFlow.',
    'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using DigitalFlow.',
    'LBL_WIZARD_NEXT_BUTTON' => 'Next >',
    'LBL_WIZARD_BACK_BUTTON' => '< Back',
    'LBL_WIZARD_SKIP_BUTTON' => 'Skip',
    'LBL_WIZARD_FINISH_BUTTON' => 'Finish',
    'LBL_WIZARD_FINISH_TITLE' => 'You are ready to use DigitalFlow!',
    'LBL_WIZARD_FINISH' => 'Click <b>Finish</b> below to save your settings and to begin using DigitalFlow. For more information on using DigitalFlow:<br /><br />
<table cellpadding=0 cellspacing=0>
<tr><td><!--not_in_theme!-->Visit 
<img src=include/images/suitecrm_login.png style="margin-right: 5px;">
</td><td><a href="#" target="_blank"><b>DigitalFlow</b></a></td></tr>
</table>',
    'LBL_WIZARD_FINISH1' => 'What would you like to do next?',
    'LBL_WIZARD_FINISH2' => 'Start Using DigitalFlow',
    ...
    'LBL_WIZARD_FINISH11' => 'Visit DigitalFlow Site',
    ...
    'LBL_WIZARD_FINISH17' => 'Tips from DigitalFlow',
    'LBL_WIZARD_FINISH18' => 'Forums',
    'LBL_WIZARD_FINISH19' => 'Forums dedicated to the DigitalFlow Community to discuss topics of interest with each other and with DigitalFlow Developers',
    ...
    'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies and names to appear in DigitalFlow.',
    ...
    'LBL_TEST_EMAIL_SUBJECT' => 'Test Email from DigitalFlow',
    'LBL_NO_SUBJECT' => '(no subject)',
    'LBL_CHECKING_ACCOUNT' => 'Checking Account',
    'LBL_OF' => 'of',
    'LBL_TEST_EMAIL_BODY' => 'This email was sent in order to test the outgoing mail server information provided in the DigitalFlow application. A successful receipt of this email indicates that the outgoing mail server information provided is valid.',
    ...
    'LBL_GOOGLE_API_TOKEN_HELP' => 'Use this to authorize DigitalFlow to access your Google Calendar. This is required for synchronization. Don\'t forget to check the "Enable Calendar Sync" checkbox when done.',
