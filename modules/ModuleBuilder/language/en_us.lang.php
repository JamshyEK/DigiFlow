...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'studioWizard' => array(
            ...
            'sugarPortalBtn' => 'Use <b>DigitalFlow Portal Editor</b> to manage and customize the DigitalFlow Portal.',
            ...
            'portalBtn' => 'Customize the module <b>Layouts</b> that appear in the <b>DigitalFlow Portal</b>.',
            ...
            'viewBtnDashlet' => 'Customize the module\'s <b>DigitalFlow Dashlet</b>, including the DigitalFlow Dashlet\'s ListView and Search.<br><br>The DigitalFlow Dashlet will be available to add to the pages in the Home module.',
            ...
            'dashletHelp' => 'The <b>DigitalFlow Dashlet</b> layouts that can be customized appear here.<br><br>The DigitalFlow Dashlet will be available to add to the pages in the Home module.',
            'DashletListViewBtn' => 'The <b>DigitalFlow Dashlet ListView</b> displays records based on the DigitalFlow Dashlet search filters.',
            'DashletSearchViewBtn' => 'The <b>DigitalFlow Dashlet Search</b> filters records for the DigitalFlow Dashlet listview.',
            ...
            'portalHelp' => 'Manage and customize the <b>DigitalFlow Portal</b>.',
            'SPUploadCSS' => 'Upload a <b>Style Sheet</b> for the DigitalFlow Portal.',
            'SPSync' => '<b>Sync</b> customizations to the DigitalFlow Portal instance.',
            'Layouts' => 'Customize the <b>Layouts</b> of the DigitalFlow Portal modules.',
            'portalLayoutHelp' => 'The modules within the DigitalFlow Portal appear in this area.<br><br>Select a module to edit the <b>Layouts</b>.',
        ...
        'portalSync' => array(
            'default' => 'Enter the <b>DigitalFlow Portal URL</b> of the portal instance to update, and click <b>Go</b>.<br><br>Then enter a valid DigitalFlow user name and password, and then click <b>Begin Sync</b>.<br><br>The customizations made to the DigitalFlow Portal <b>Layouts</b>, along with the <b>Style Sheet</b> if one was uploaded, will be transferred to specified the portal instance.',
        ),
        'portalStyle' => array(
            'default' => 'You can customize the look of the DigitalFlow Portal by using a style sheet.<br><br>Select a <b>Style Sheet</b> to upload.<br><br>The style sheet will be implemented in the DigitalFlow Portal the next time a sync is performed.',
        ),
    ),
    ...
    'assistantHelp' => array(
        'package' => array(
            ...
            'afterSave' => 'Your new package should contain at least one module. You can create one or more custom modules for the package.<br/><br/>Click <b>New Module</b> to create a custom module for this package.<br/><br/> After creating at least one module, you can publish or deploy the package to make it available for your instance and/or other users\' instances.<br/><br/> To deploy the package in one step within your DigitalFlow instance, click <b>Deploy</b>.<br><br>Click <b>Publish</b> to save the package as a .zip file. After the .zip file is saved to your system, use the <b>Module Loader</b> to upload and install the package within your DigitalFlow instance. <br/><br/>You can distribute the file to other users to upload and install within their own DigitalFlow instances.',
        ...
        'module' => array(
            'somemodules' => "Since the current package contains at least one module, you can <b>Deploy</b> the modules in the package within your DigitalFlow instance or <b>Publish</b> the package to be installed in the current DigitalFlow instance or another instance using the <b>Module Loader</b>.<br/><br/>To install the package directly within your DigitalFlow instance, click <b>Deploy</b>.<br><br>To create a .zip file for the package that can be loaded and installed within the current DigitalFlow instance and other instances using the <b>Module Loader</b>, click <b>Publish</b>.<br/><br/> You can build the modules for this package in stages, and publish or deploy when you are ready to do so. <br/><br/>After publishing or deploying a package, you can make changes to the package properties and customize the modules further. Then re-publish or re-deploy the package to apply the changes.",
...
//STUDIO2
    ...
    'LBL_SUITEPORTAL' => 'DigitalFlow Portal Editor',
    ...
    'LBL_DASHLET' => 'DigitalFlow Dashlet',
    'LBL_DASHLETLISTVIEW' => 'DigitalFlow Dashlet ListView',
    'LBL_POPUP' => 'Popup View',
    'LBL_POPUPLISTVIEW' => 'Popup ListView',
    'LBL_POPUPSEARCH' => 'Popup Search',
    'LBL_DASHLETSEARCHVIEW' => 'DigitalFlow Dashlet Search',
