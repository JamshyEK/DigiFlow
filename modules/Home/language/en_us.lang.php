...
$mod_strings = array(
    ...
    'LBL_ADD_DASHLETS' => 'Add DigitalFlow Dashlets',
    ...
    'LBL_DASHLET_DELETE' => 'Delete DigitalFlow Dashlet',
    'LBL_DASHLET_REFRESH' => 'Refresh DigitalFlow Dashlet',
    'LBL_DASHLET_EDIT' => 'Edit DigitalFlow Dashlet',

    // Default out-of-box names for tabs
    'LBL_HOME_PAGE_1_NAME' => 'My DigitalFlow',
...
//ABOUT page
    ...
    'LBL_DASHLET_SUITE_NEWS' => 'News',
    'LBL_DASHLET_DISCOVER_SUITE' => 'Discover DigitalFlow',
    ...
    'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => 'DigitalFlow application notifications would go here.',
    ...
    'LBL_TOUR_WELCOME' => 'Welcome to DigitalFlow',
    'LBL_TOUR_WATCH' => 'Watch What\'s New in DigitalFlow',
    ...
    'LBL_TOUR_CALENDAR_URL_1' => 'Do you share your DigitalFlow calendar with 3rd party applications, such as Microsoft Outlook or Exchange? If so, you have a new URL. This new, more secure URL includes a personal key which will prevent unauthorized publishing of your calendar.',
    'LBL_TOUR_CALENDAR_URL_2' => 'Retrieve your new shared calendar URL.',
    'LBL_CONTRIBUTORS' => 'Contributors',
    'LBL_ABOUT_SUITE' => 'About DigitalFlow',
    'LBL_PARTNERS' => 'Partners',
    'LBL_FEATURING' => 'AOS, AOW, AOR, AOP, AOE and Reschedule modules by SalesAgility.',

    'LBL_CONTRIBUTOR_SUITECRM' => 'DigitalFlow - Open source CRM for the world',
    ...
    'LBL_CONTRIBUTOR_CONSCIOUS' => 'DigitalFlow LOGO Provided by Conscious Solutions',
    'LBL_CONTRIBUTOR_RESPONSETAP' => 'Contribution to DigitalFlow 7.3 release by ResponseTap',
    'LBL_CONTRIBUTOR_GMBH' => 'Workflow Calculated Fields contributed by diligent technology & business consulting GmbH',

    'LBL_LANGUAGE_ABOUT' => 'About DigitalFlow Translations',
    'LBL_LANGUAGE_COMMUNITY_ABOUT' => 'Collaborative translation by the DigitalFlow Community',
    'LBL_LANGUAGE_COMMUNITY_PACKS' => 'Translation created using Crowdin',

    'LBL_ABOUT_SUITE_2' => 'DigitalFlow is published under an open source licence - AGPLv3',
    'LBL_ABOUT_SUITE_4' => 'All DigitalFlow code managed and developed by the project will be released as open source - AGPLv3',
    'LBL_ABOUT_SUITE_5' => 'DigitalFlow support is available in both free and paid-for options',

    'LBL_SUITE_PARTNERS' => 'We have loyal DigitalFlow partners who are passionate about open source. To view our full partner list, see our website.',
