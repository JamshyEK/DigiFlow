...
$mod_strings = array(
    ...
    'LBL_EMAIL_LINK_TYPE_HELP' => '<b>DigitalFlow Mail Client:</b> Send emails using the email client in the DigitalFlow application.<br><b>External Mail Client:</b> Send email using an email client outside of the DigitalFlow application, such as Microsoft Outlook.',
