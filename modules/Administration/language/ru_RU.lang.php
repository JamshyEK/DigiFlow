...
$mod_strings = array(
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Загружаемый файл не совместим с установленной версией DigitalFlow: ',
    'HDR_LOGIN_PANEL' => 'Пожалуйста, введите ваши учётные данные для DigitalFlow.com.',
...
Последняя попытка подключения @ ',
    ...
    'LBL_LDAP_HELP_TXT' => 'При включении LDAP-аутентификации управление паролями осуществляется только через LDAP. Настройки системы управления паролями DigitalFlow не будут учитываться.',
    ...
    'LBL_LDAP_USER_FILTER_DESC' => 'Любые дополнительные параметры, применяемые в процессе аутентификации пользователей, например: <em>is_DigitalFlow_user=1 или (is_DigitalFlow_user=1)(is_sales=1)</em>',
    ...
    'LBL_LDAP_GROUP_NAME_DESC' => 'Пример: <em>cn=DigitalFlow</em>',
    'LBL_LDAP_USER_DN_DESC' => 'Пример: <em>ou=people,dc=example,dc=com</eM>',
    'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'Если аутентифицированный пользователь не существует в базе DigitalFlow, то он будет создан.',
    ...
    'LBL_MI_IN_DASHLETS' => 'Установка DigitalFlow Dashlet ',
    'LBL_MI_UN_DASHLETS' => 'Удаление DigitalFlow Dashlet ',
    ...
    'LBL_SUGAR_UPDATE_TITLE' => 'Обновление DigitalFlow',
    ...
    'LBL_MODULEBUILDER_DESC' => 'Создание новых модулей для расширения функциональности DigitalFlow',
    ...
    'ML_RELAX_LOCAL' => 'Если DigitalFlow используется только в локальной сети, вы можете уменьшить ограничения Загрузчика Модулей на разрешение установки пакета.',
    'ML_SUGAR_KB' => 'База знаний DigitalFlow',
    'ML_SUGAR_DZ' => 'Зона разработчика DigitalFlow',
    'ML_AVAIL_RESTRICTION' => 'Имеющиеся ограничения и исключения подробно изложены в',
    'ML_OVERRIDE_CORE_FILES' => 'Переопределение основных файлов DigitalFlow не допускается ',
